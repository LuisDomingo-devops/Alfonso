'''
Event Bus con asyncio
Crear app/core/event_bus.py. El orquestador actual despacha todo él mismo; necesitas un bus que permita publicar eventos y 
que los agentes suscriban a los que les corresponden. 
Implementación con asyncio.Queue primero (sin Redis/NATS todavía, siguiendo el roadmap realista).
