"""
AGENTE MARCOS — Inicialización del subpaquete marcos.

¿QUÉ HACE?
Expone e inicializa el agente legal (MarcosAgent).

¿CUÁNDO LO HACE?
Al importar marcos_agent desde app.domain.agents.marcos.
